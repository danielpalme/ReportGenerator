...
\hypersetup{pdftitle={Coverage Report},
            pdfauthor={ReportGenerator - 5.1.26.0}
           }

\pagestyle{fancy}
\fancyhead[LE,LO]{\leftmark}
\fancyhead[R]{\thepage}
\fancyfoot[C]{ReportGenerator - 5.1.26.0}
...
\textbf{Generated on:} & 05.10.2023 - 22:36:20\\
...
\hline
\textbf{Sample} & \textbf{75} & \textbf{33} & \textbf{108} & \textbf{273} & \textbf{69.4\%} & \textbf{50\%} & \textbf{66.6\%}\\
\hline
Sample.PartialClass & 12 & 10 & 22 & 53 & 54.5\% & 50\% & 50\%\\
\hline
Test.Program & 15 & 0 & 15 & 75 & 100\% &  & 100\%\\
\hline
Test.TestClass & 24 & 9 & 33 & 60 & 72.7\% & 50\% & 80\%\\
\hline
...
\cellcolor{gray} &  & \verb~6~ & & \verb~{~\\
\cellcolor{gray} &  & \verb~7~ & & \verb~    public class Program~\\
\cellcolor{gray} &  & \verb~8~ & & \verb~    {~\\
\cellcolor{gray} &  & \verb~9~ & & \verb~        public static void Main(string[] args)~\\
\cellcolor{gray} &  & \verb~10~ & & \verb~        {~\\
\cellcolor{gray} &  & \verb~11~ & & \verb~            new TestClass().SampleFunction();~\\
\cellcolor{gray} &  & \verb~12~ & & \verb~            new TestClass().ParentMethod();~\\
\cellcolor{gray} &  & \verb~13~ & & \verb~            new TestClass().MethodWithLambda();~\\
...
\cellcolor{gray} &  & \verb~48~ & & \verb~            new GenericAsyncClass<object>().MyAsyncMethod().Wait();~\\
\cellcolor{gray} &  & \verb~49~ & & \verb~            new ClassWithLocalFunctions<object>.MyNestedClass<object>().MyAsyncMethod<object>(null).GetAwaiter().GetResu~\\
\cellcolor{green} & 2 & \verb~50~ & & \verb~        }~\\
\cellcolor{gray} &  & \verb~51~ & & \verb~~\\
\cellcolor{gray} &  & \verb~52~ & & \verb~        private static async void CallAsyncMethod()~\\
\cellcolor{gray} &  & \verb~53~ & & \verb~        {~\\
\cellcolor{gray} &  & \verb~54~ & & \verb~            var expected = new HttpResponseMessage();~\\
\cellcolor{gray} &  & \verb~55~ & & \verb~            var handler = new AsyncClass() { InnerHandler = new EchoHandler(expected) };~\\
\cellcolor{gray} &  & \verb~56~ & & \verb~            var invoker = new HttpMessageInvoker(handler, false);~\\
\cellcolor{gray} &  & \verb~57~ & & \verb~            var actual = await invoker.SendAsync(new HttpRequestMessage(), new CancellationToken());~\\
\cellcolor{gray} &  & \verb~58~ & & \verb~        }~\\
\cellcolor{gray} &  & \verb~59~ & & \verb~~\\
\cellcolor{gray} &  & \verb~60~ & & \verb~        private class EchoHandler : DelegatingHandler~\\
\cellcolor{gray} &  & \verb~61~ & & \verb~        {~\\
\cellcolor{green} & 1 & \verb~62~ & & \verb~            private HttpResponseMessage _response;~\\
\cellcolor{green} & 1 & \verb~63~ & & \verb~~\\
\cellcolor{green} & 1 & \verb~64~ & & \verb~            public EchoHandler(HttpResponseMessage response)~\\
\cellcolor{green} & 1 & \verb~65~ & & \verb~            {~\\
\cellcolor{green} & 1 & \verb~66~ & & \verb~                this._response = response;~\\
\cellcolor{green} & 1 & \verb~67~ & & \verb~            }~\\
\cellcolor{gray} &  & \verb~68~ & & \verb~~\\
\cellcolor{gray} &  & \verb~69~ & & \verb~            protected override Task<HttpResponseMessage> SendAsync(HttpRequestMessage request, CancellationToken cancell~\\
\cellcolor{gray} &  & \verb~70~ & & \verb~            {~\\
\cellcolor{gray} &  & \verb~71~ & & \verb~                return Task.FromResult(this._response);~\\
...
\textbf{} & \textbf{\#} & \textbf{Line} & \textbf{} & \textbf{Line coverage}\\
\cellcolor{gray} &  & \verb~1~ & & \verb~using System;~\\
\cellcolor{gray} &  & \verb~2~ & & \verb~using System.Linq;~\\
\cellcolor{gray} &  & \verb~3~ & & \verb~~\\
\cellcolor{gray} &  & \verb~4~ & & \verb~namespace Test~\\
\cellcolor{gray} &  & \verb~5~ & & \verb~{~\\
\cellcolor{gray} &  & \verb~6~ & & \verb~    class TestClass~\\
\cellcolor{gray} &  & \verb~7~ & & \verb~    {~\\
\cellcolor{gray} &  & \verb~8~ & & \verb~        public void SampleFunction()~\\
\cellcolor{green} & 2 & \verb~9~ & & \verb~        {~\\
\cellcolor{green} & 2 & \verb~10~ & & \verb~            string test = string.Format(~\\
\cellcolor{green} & 2 & \verb~11~ & & \verb~                "{0} {1}",~\\
\cellcolor{green} & 2 & \verb~12~ & & \verb~                 "Hello",~\\
\cellcolor{green} & 2 & \verb~13~ & & \verb~                 "World");~\\
\cellcolor{gray} &  & \verb~14~ & & \verb~~\\
\cellcolor{green} & 2 & \verb~15~ & & \verb~            Console.WriteLine(test);~\\
\cellcolor{green} & 2 & \verb~16~ & & \verb~            int i = 10;~\\
\cellcolor{gray} &  & \verb~17~ & & \verb~~\\
\cellcolor{orange} & 2 & \verb~18~ & & \verb~            if (i > 0 || i > 1)~\\
\cellcolor{green} & 2 & \verb~19~ & & \verb~            {~\\
\cellcolor{green} & 2 & \verb~20~ & & \verb~                Console.WriteLine(i + " is greater that 0");~\\
\cellcolor{green} & 2 & \verb~21~ & & \verb~            }~\\
\cellcolor{gray} &  & \verb~22~ & & \verb~            else~\\
\cellcolor{red} & 0 & \verb~23~ & & \verb~            {~\\
\cellcolor{red} & 0 & \verb~24~ & & \verb~                Console.WriteLine(i + " is not greater that 0");~\\
\cellcolor{red} & 0 & \verb~25~ & & \verb~            }~\\
\cellcolor{green} & 2 & \verb~26~ & & \verb~        }~\\
\cellcolor{gray} &  & \verb~27~ & & \verb~~\\
\cellcolor{gray} &  & \verb~28~ & & \verb~        public void ParentMethod()~\\
\cellcolor{green} & 2 & \verb~29~ & & \verb~        {~\\
\cellcolor{green} & 2 & \verb~30~ & & \verb~            string resultFromLocalFunction = NestedLocalFunction("Hello");~\\
\cellcolor{gray} &  & \verb~31~ & & \verb~~\\
\cellcolor{green} & 2 & \verb~32~ & & \verb~            Console.WriteLine(resultFromLocalFunction);~\\
\cellcolor{gray} &  & \verb~33~ & & \verb~~\\
\cellcolor{gray} &  & \verb~34~ & & \verb~            string NestedLocalFunction(string input)~\\
\cellcolor{green} & 2 & \verb~35~ & & \verb~            {~\\
\cellcolor{green} & 2 & \verb~36~ & & \verb~                return input + " world";~\\
\cellcolor{green} & 2 & \verb~37~ & & \verb~            }~\\
\cellcolor{green} & 2 & \verb~38~ & & \verb~        }~\\
\cellcolor{gray} &  & \verb~39~ & & \verb~~\\
\cellcolor{gray} &  & \verb~40~ & & \verb~        public void MethodWithLambda()~\\
\cellcolor{green} & 2 & \verb~41~ & & \verb~        {~\\
\cellcolor{green} & 8 & \verb~42~ & & \verb~            var chars = "abc".Where(c => c == 'a').ToArray();~\\
\cellcolor{gray} &  & \verb~43~ & & \verb~~\\
\cellcolor{green} & 8 & \verb~44~ & & \verb~            var lambda = (char c) => c == 'a';~\\
\cellcolor{gray} &  & \verb~45~ & & \verb~~\\
\cellcolor{green} & 2 & \verb~46~ & & \verb~            var chars2 = "abc".Where(lambda).ToArray();~\\
\cellcolor{green} & 2 & \verb~47~ & & \verb~        }~\\
\cellcolor{gray} &  & \verb~48~ & & \verb~~\\
\cellcolor{gray} &  & \verb~49~ & & \verb~        public class NestedClass~\\
\cellcolor{gray} &  & \verb~50~ & & \verb~        {~\\
\cellcolor{gray} &  & \verb~51~ & & \verb~            public void SampleFunction()~\\
\cellcolor{red} & 0 & \verb~52~ & & \verb~            {~\\
\cellcolor{red} & 0 & \verb~53~ & & \verb~                Console.WriteLine(~\\
\cellcolor{red} & 0 & \verb~54~ & & \verb~                    "{0} {1}",~\\
\cellcolor{red} & 0 & \verb~55~ & & \verb~                     "Hello",~\\
\cellcolor{red} & 0 & \verb~56~ & & \verb~                     "World");~\\
