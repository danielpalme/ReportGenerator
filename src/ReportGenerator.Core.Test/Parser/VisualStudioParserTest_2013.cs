...
namespace Palmmedia.ReportGeneratorTest.Parser
{
    ...
    public class VisualStudioParserTest_2013
    {
        ...
        {
            Assert.Single(assemblies.Single(a => a.Name == "test.exe").Classes.Single(c => c.Name == "Test.TestClass").Files);
            Assert.Equal(2, assemblies.Single(a => a.Name == "test.exe").Classes.Single(c => c.Name == "Test.PartialClass").Files.Count());
        }
        ...
        {
            Assert.Equal(4, assemblies.Single(a => a.Name == "test.exe").Classes.Single(c => c.Name == "Test.AbstractClass").CoverableLines);
        }
        ...
        public void MethodMetricsTest()
        {
            ...
            metrics = assemblies.Single(a => a.Name == "test.exe").Classes.Single(c => c.Name == "Test.AsyncClass").Files.Single(f => f.Path == "C:\\temp\\AsyncClass.cs").MethodMetrics;
