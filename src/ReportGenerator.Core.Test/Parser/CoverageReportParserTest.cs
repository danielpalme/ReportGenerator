...
namespace Palmmedia.ReportGenerator.Core.Test.Parser
{
    ...
    public class CoverageReportParserTest
    {
        ...
        public void ParseFiles_SingleReportFileWithSingleReport_PartCoverNotSupported()
        {
            ...
            Assert.Throws<UnsupportedParserException>(() => new CoverageReportParser(1, 1, 1, new string[0], this.filterMock.Object, this.filterMock.Object, this.filterMock.Object).ParseFiles(new string[] { filePath }));
        ...
        public void ParseFiles_SingleReportFileWithSingleReport_CorrectParserIsReturned()
        {
            ...
            var parserResult = new CoverageReportParser(1, 1, 1, new string[] { "C:\\somedirectory" }, this.filterMock.Object, this.filterMock.Object, this.filterMock.Object).ParseFiles(new string[] { filePath });
            ...
            parserResult = new CoverageReportParser(1, 1, 1, new string[] { "C:\\somedirectory" }, this.filterMock.Object, this.filterMock.Object, this.filterMock.Object).ParseFiles(new string[] { filePath });
        ...
        public void ParseFiles_SingleReportFileWithSeveralReports_CorrectParserIsReturned()
        {
            ...
            string parserName = new CoverageReportParser(1, 1, 1, new string[0], this.filterMock.Object, this.filterMock.Object, this.filterMock.Object).ParseFiles(new string[] { filePath }).ParserName;
            ...
            parserName = new CoverageReportParser(1, 1, 1, new string[0], this.filterMock.Object, this.filterMock.Object, this.filterMock.Object).ParseFiles(new string[] { filePath }).ParserName;
        ...
        public void ParseFiles_SeveralReportFilesWithSingleReport_CorrectParserIsReturned()
        {
            ...
            string parserName = new CoverageReportParser(1, 1, 1, new string[0], this.filterMock.Object, this.filterMock.Object, this.filterMock.Object).ParseFiles(new string[] { filePath, filePath2 }).ParserName;
        ...
        {
            string parserName = new CoverageReportParser(1, 1, 1, new string[0], this.filterMock.Object, this.filterMock.Object, this.filterMock.Object).ParseFiles(new string[] { string.Empty }).ParserName;
