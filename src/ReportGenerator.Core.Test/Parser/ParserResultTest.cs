...
namespace Palmmedia.ReportGenerator.Core.Test.Parser
{
    ...
    public class ParserResultTest
    {
        ...
        public ParserResultTest()
        {
            ...
            this.parserResultWithoutPreprocessing = new OpenCoverParser(filterMock.Object, filterMock.Object, filterMock.Object, filterMock.Object).Parse(XDocument.Load(FilePath));
            this.parserResultWithoutPreprocessing.Merge(new OpenCoverParser(filterMock.Object, filterMock.Object, filterMock.Object, filterMock.Object).Parse(XDocument.Load(FilePath)));

            var report = XDocument.Load(FilePath);
            new OpenCoverReportPreprocessor().Execute(report);
            this.parserResultWithPreprocessing = new OpenCoverParser(filterMock.Object, filterMock.Object, filterMock.Object, filterMock.Object).Parse(report);

            report = XDocument.Load(FilePath);
            new OpenCoverReportPreprocessor().Execute(report);
            this.parserResultWithPreprocessing.Merge(new OpenCoverParser(filterMock.Object, filterMock.Object, filterMock.Object, filterMock.Object).Parse(report));
        }
        ...
        public void OpenCoverMethodMetricsTest()
        {
            ...
            var parserResult = new CoverageReportParser(1, 1, new string[0], filterMock.Object, filterMock.Object, filterMock.Object, filterMock.Object).ParseFiles(new string[] { filePath });
