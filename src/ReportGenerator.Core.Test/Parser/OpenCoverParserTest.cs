...
namespace Palmmedia.ReportGenerator.Core.Test.Parser
{
    ...
    public class OpenCoverParserTest
    {
        ...
        public OpenCoverParserTest()
        {
            ...
            this.parserResultWithoutPreprocessing = new OpenCoverParser(filterMock.Object, filterMock.Object, filterMock.Object, filterMock.Object).Parse(XDocument.Load(FilePath1));
            ...
            new OpenCoverReportPreprocessor().Execute(report);
            this.parserResultWithTrackedMethods = new OpenCoverParser(filterMock.Object, filterMock.Object, filterMock.Object, filterMock.Object).Parse(report);
        }
