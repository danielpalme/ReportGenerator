...
namespace Palmmedia.ReportGeneratorTest.Parser
{
    ...
    public class MProfParserTest
    {
        ...
        public void NumberOfLineVisitsTest()
        {
            ...
            Assert.AreEqual(1, fileAnalysis.Lines.Single(l => l.LineNumber == 18).LineVisits, "Wrong number of line visits");
        ...
        {
            Assert.AreEqual(8, assemblies.SelectMany(a => a.Classes).SelectMany(a => a.Files).Distinct().Count(), "Wrong number of files");
        }
        ...
        public void CodeElementsTest()
        {
            ...
            Assert.AreEqual(3, codeElements.Count(), "Wrong number of code elements");
        }
