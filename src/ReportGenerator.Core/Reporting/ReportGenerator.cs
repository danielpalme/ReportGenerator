...
namespace Palmmedia.ReportGenerator.Core.Reporting
{
    ...
    public class ReportGenerator
    {
        ...
        public ReportGenerator(IFileReader fileReader, ParserResult parserResult, IEnumerable<IReportBuilder> renderers)
        {
        ...
        public void CreateReport(bool addHistoricCoverage, List<HistoricCoverage> overallHistoricCoverages, DateTime executionTime, string tag)
        {
