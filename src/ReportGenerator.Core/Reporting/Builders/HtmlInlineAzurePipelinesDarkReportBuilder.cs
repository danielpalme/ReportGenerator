...
namespace Palmmedia.ReportGenerator.Core.Reporting.Builders
{
    ...
    public class HtmlInlineAzurePipelinesDarkReportBuilder : HtmlReportBuilderBase
    {
        ...
        {
            using (var renderer = new HtmlRenderer(this.fileNameByClass, false, HtmlMode.InlineCssAndJavaScript, "custom-azurepipelines.css", "custom-azurepipelines_dark.css", this.ReportContext.Settings.IncludeAllDatesInCharts))
            {
