...
namespace Palmmedia.ReportGenerator.Core.Reporting.Builders
{
    ...
    public class HtmlBlueRedReportBuilder : HtmlReportBuilderBase
    {
        ...
        {
            using (var renderer = new HtmlRenderer(this.fileNameByClass, false, this.htmlMode, new string[] { "custom_adaptive.css", "custom_bluered.css" }, "custom.css", this.ReportContext.Settings.IncludeAllDatesInCharts))
            {
