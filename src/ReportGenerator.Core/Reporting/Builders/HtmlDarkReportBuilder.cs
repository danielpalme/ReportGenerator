...
namespace Palmmedia.ReportGenerator.Core.Reporting.Builders
{
    ...
    public class HtmlDarkReportBuilder : HtmlReportBuilderBase
    {
        ...
        {
            using (var renderer = new HtmlRenderer(this.fileNameByClass, false, this.htmlMode, "custom.css", "custom_dark.css", this.ReportContext.Settings.IncludeAllDatesInCharts))
            {
