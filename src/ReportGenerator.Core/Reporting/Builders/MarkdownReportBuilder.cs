...
namespace Palmmedia.ReportGenerator.Core.Reporting.Builders
{
    ...
    /// </summary>
    public class MarkdownReportBuilder : MarkdownReportBuilderBase, IDisposable
    {
        /// <summary>
        /// The shared renderer.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MarkdownReportBuilder"/> class.
        /// </summary>
        public MarkdownReportBuilder()
        {
            this.WithLinks = true;
        }
        ...
        /// </value>
        public override string ReportType => "Markdown";
