...
namespace Palmmedia.ReportGenerator.Core.Reporting.Builders
{
    ...
    public class HtmlInlineAzurePipelinesLightReportBuilder : HtmlReportBuilderBase
    {
        ...
        {
            using (var renderer = new HtmlRenderer(this.fileNameByClass, false, HtmlMode.InlineCssAndJavaScript, "custom-azurepipelines.css", null, this.ReportContext.Settings.IncludeAllDatesInCharts))
            {
