...
namespace Palmmedia.ReportGenerator.Core.Parser
{
    ...
    internal class OpenCoverParser : ParserBase
    {
        ...
        private Class ProcessClass(Dictionary<string, HashSet<string>> fileIdsByFilename, Assembly assembly, string className)
        {
            ...
            {
                @class.AddFile(this.ProcessFile(fileIdsByFilename[file], file, methods));
            }

            @class.CoverageQuota = this.GetCoverageQuotaOfClass(methods);
        ...
        private CodeFile ProcessFile(HashSet<string> fileIds, string filePath, XElement[] methods)
        {
        ...
        private decimal? GetCoverageQuotaOfClass(XElement[] methods)
        {
