...
namespace Palmmedia.ReportGenerator.Core.Parser
{
    ...
    internal class NCoverParser : ParserBase
    {
        ...
        internal NCoverParser(IFilter assemblyFilter, IFilter classFilter, IFilter fileFilter) : base(assemblyFilter, classFilter, fileFilter)
        {
        }
        ...
        public override ParserResult Parse(XContainer report)
        {
            ...
            Parallel.ForEach(assemblyNames, assemblyName => assemblies.Add(this.ProcessAssembly(modules, assemblyName)));
