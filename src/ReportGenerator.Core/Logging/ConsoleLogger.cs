...
namespace Palmmedia.ReportGenerator.Core.Logging
{
    ...
    internal class ConsoleLogger : ILogger
    {
        ...
        {
            private static readonly BlockingCollection<Tuple<string, ConsoleColor>> s_Queue = new BlockingCollection<Tuple<string, ConsoleColor>>();
            ...
            {
                s_Queue.Add(new Tuple<string, ConsoleColor>(message, color));
            }
        }
    }
}
