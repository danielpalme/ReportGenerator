...
### Installation
```
dotnet tool install --global dotnet-reportgenerator-globaltool --version 5.4.2

dotnet tool install dotnet-reportgenerator-globaltool --tool-path tools --version 5.4.2

dotnet new tool-manifest
dotnet tool install dotnet-reportgenerator-globaltool --version 5.4.2
```
