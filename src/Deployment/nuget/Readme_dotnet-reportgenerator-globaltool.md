...
dotnet tool install dotnet-reportgenerator-globaltool --tool-path tools --version 5.4.9

dotnet new tool-manifest
dotnet tool install dotnet-reportgenerator-globaltool --version 5.4.9
```
