...
dotnet tool install dotnet-reportgenerator-globaltool --tool-path tools --version 5.5.0

dotnet new tool-manifest
dotnet tool install dotnet-reportgenerator-globaltool --version 5.5.0
```
