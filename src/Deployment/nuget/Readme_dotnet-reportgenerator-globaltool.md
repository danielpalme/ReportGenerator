...
dotnet tool install dotnet-reportgenerator-globaltool --tool-path tools --version 5.3.6

dotnet new tool-manifest
dotnet tool install dotnet-reportgenerator-globaltool --version 5.3.6
```
