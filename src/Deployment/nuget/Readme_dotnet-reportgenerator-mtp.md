# ReportGenerator - *dotnet-reportgenerator-mtp*
...
|[dotnet-reportgenerator-mtp](https://www.nuget.org/packages/dotnet-reportgenerator-mtp)|.NET Core|Use this package if you want full integration with *Microsoft Testing Platform* (MTP).|
