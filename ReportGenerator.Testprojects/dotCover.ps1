..\packages\JetBrains.dotCover.CommandLineTools.10.0.20151218.134438\tools\dotCover.exe a /TargetExecutable=CSharp\Project\bin\Debug\Test.exe /ReportType=DetailedXML /Output=CSharp\Reports\dotCover.xml

..\packages\JetBrains.dotCover.CommandLineTools.10.0.20151218.134438\tools\dotCover.exe  a /TargetExecutable=FSharp\Project\bin\Debug\Test.exe /ReportType=DetailedXML /Output=FSharp\Reports\dotCover.xml
